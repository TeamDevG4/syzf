...
import org.group4.ui.MainFrame;
public class ProgressBar implements ActionListener{
    ...
    public ProgressBar(){
    	HttpUtil httpUtilThread=new HttpUtil();
        ProgressBar.show(MainFrame.getInstance(), httpUtilThread, "正在拼了命为您获取用户信息,请稍候……", "登陆成功", "登陆失败，请查看网络是否连接！");        
    }
